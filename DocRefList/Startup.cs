...
namespace DocRefList
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddStartupTask<InitAndSeedDatabase>();

            services.AddDatabaseAccess(Configuration.GetConnectionString("DocRefListConnection"));

            services.Configure<InitDBSetting>(Configuration.GetSection("InitDBAccount"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=Documents}/{action=List}/{id?}");
            });
        }
    }
}
